import { default as AsyncRetry } from 'async-retry';
...
export declare type QuoteRetryOptions = AsyncRetry.Options;
/**
...
export declare class V3QuoteProvider implements IV3QuoteProvider {
     ...
     */
    constructor(chainId: ChainId, provider: providers.BaseProvider, multicall2Provider: UniswapMulticallProvider, retryOptions?: QuoteRetryOptions, batchParams?: BatchParams, gasErrorFailureOverride?: FailureOverrides, successRateFailureOverrides?: FailureOverrides, blockNumberConfig?: BlockNumberConfig, quoterAddressOverride?: string | undefined);
    getQuotesManyExactIn(amountIns: CurrencyAmount[], routes: V3Route[], providerConfig?: ProviderConfig): Promise<{
        routesWithQuotes: V3RouteWithQuotes[];
        blockNumber: BigNumber;
    }>;
